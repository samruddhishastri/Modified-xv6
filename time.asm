  ...
  16:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  int pid = fork();
  1e:	e8 c8 02 00 00       	call   2eb <fork>
  if(pid == 0){
  23:	85 c0                	test   %eax,%eax
  25:	75 13                	jne    3a <main+0x3a>
    exec(argv[1], argv + 1);
  27:	8d 43 04             	lea    0x4(%ebx),%eax
  2a:	52                   	push   %edx
  2b:	52                   	push   %edx
  2c:	50                   	push   %eax
  2d:	ff 73 04             	pushl  0x4(%ebx)
  30:	e8 fe 02 00 00       	call   333 <exec>
    exit();
  ...
  72:	51                   	push   %ecx
  73:	51                   	push   %ecx
  74:	68 c8 07 00 00       	push   $0x7c8
  79:	6a 01                	push   $0x1
  7b:	e8 e0 03 00 00       	call   460 <printf>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 04 08 00 00       	mov    $0x804,%ebx
        while(*s != 0){
