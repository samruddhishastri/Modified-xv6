  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  if(priority < 0 || priority > 100){
  4d:	83 fb 64             	cmp    $0x64,%ebx
  50:	76 13                	jbe    65 <main+0x65>
  ...
  5b:	e8 20 04 00 00       	call   480 <printf>
    exit();
  60:	e8 ae 02 00 00       	call   313 <exit>
  }
  ...
  67:	56                   	push   %esi
  68:	53                   	push   %ebx
  69:	e8 55 03 00 00       	call   3c3 <set_priority>
  if(ret != -1)
  6e:	83 c4 10             	add    $0x10,%esp
  71:	83 f8 ff             	cmp    $0xffffffff,%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb aa 08 00 00       	mov    $0x8aa,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 655:	a1 64 0b 00 00       	mov    0xb64,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 64 0b 00 00       	mov    %eax,0xb64
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 64 0b 00 00       	mov    %eax,0xb64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d 64 0b 00 00    	mov    0xb64,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 64 0b 00 00       	mov    0xb64,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 64 0b 00 00       	mov    %eax,0xb64
}
